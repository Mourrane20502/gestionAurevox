                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="bg-muted/10 border-b border-border">
                                    ...
                                    <TableHead className="text-center py-5 text-[10px] font-black uppercase tracking-widest text-foreground">P.U. HT</TableHead>
                                    <TableHead className="text-center py-5 text-[10px] font-black uppercase tracking-widest text-foreground">TVA</TableHead>
                                    <TableHead className="text-right pr-8 py-5 text-[10px] font-black uppercase tracking-widest text-foreground">Total HT</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {items.map((it, idx) => (
                ...
                <Card className="w-full md:w-[320px] border border-border overflow-hidden bg-white dark:bg-zinc-900 shadow-xl relative">
                    ...
                    <CardContent className="p-6 space-y-4">
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between items-center group text-sm">
                                <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground group-hover:text-indigo-600 transition-colors">TVA Estimée</span>
                        ...
                        <div className="flex flex-col gap-1 items-end pt-1">
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-500 mb-1">Montant Total TTC</span>
