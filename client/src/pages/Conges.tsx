...
import GestionERPLogo from "@/assets/sous_logo.jpg";
...
export default function Conges() {
    ...
    const handlePrintDemandeConge = async (
        ...
        try {
            ...
            const paragraphs = [
                "",
                `Je soussigné(e) ${fullName}, employé(e) de la société Gestion ERP,`,
                `affecté(e) à l'établissement ${conge.pv_name || "Gestion ERP"}, sollicite un congé :`,
                ``,
