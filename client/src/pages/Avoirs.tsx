...
export default function Avoirs() {
    ...
    const filteredAvoirs = avoirs.filter(a => {
        ...
        return matchesSearch && matchesMonth && matchesYear && matchesStatus && matchesClientType && matchesUser && matchesClient && matchesSousSociete;
    });
    ...
    const exportToPDF = async () => {
        try {
            ...
            autoTable(doc, {
                startY: 45,
                head: [["Numéro", "Client", "Banque", "Montant TTC", "Date", "Statut", "Utilisateur"]],
                body: tableData,
                theme: "grid",
                headStyles: {
                    fillColor: [67, 56, 202],
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="list" className="space-y-4">
                    <div className="flex flex-col gap-4">
                        ...
                        {showFilters && (
                            <div className="bg-muted/30 p-4 rounded-[1.5rem] border border-border grid grid-cols-1 sm:grid-cols-5 lg:grid-cols-6 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
                                        ...
                                        <Table containerClassName="overflow-visible">
                                            <TableHeader>
                                                <TableRow className="bg-muted/30">
                                                    ...
                                                    <TableHead className="text-[10px] font-bold uppercase text-center py-4">Prix Unit (HT)</TableHead>
                                                    ...
                                                    <TableHead className="text-[10px] font-bold uppercase text-right py-4 pr-6">Total HT</TableHead>
                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Card className="bg-muted/30 border-none shadow-none p-4 rounded-xl transition-all hover:bg-muted/50">
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1.5">Total HT Crédité</p>
