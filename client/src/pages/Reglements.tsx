...
export default function Reglements() {
    ...
    }, [reglements, searchTerm, filterClient, filterStatut, filterType, filterCommandeFacturee, commandeToFacture]);

    // Reset page to 1 when filters change
    useEffect(() => {
        setCurrentPage(1);
    }, [searchTerm, filterClient, filterStatut, filterType, filterCommandeFacturee]);
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <Select value={filterCommandeFacturee} onValueChange={setFilterCommandeFacturee}>
                            <SelectTrigger className="h-10">
                                <SelectValue placeholder="Commande facturée ou non" />
                            </SelectTrigger>
                            <SelectContent>
                            ...
                            <TableBody>
                                ...
                                {!isLoading && filteredReglements.length > 0 && (
                                    <TableRow className="bg-emerald-50/30 dark:bg-emerald-900/10 border-t-2 border-emerald-100 dark:border-emerald-900/30">
                                        <TableCell colSpan={4} className="px-6 py-4 font-bold text-emerald-700 dark:text-emerald-300 uppercase tracking-wider text-xs">
