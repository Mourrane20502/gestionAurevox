...
export default function Remboursements() {
    ...
    const filteredList = list.filter(r => {
        ...
        return matchesFilter && matchesSearch && matchesMonth && matchesYear && matchesStatus && matchesSousSociete;
    });
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [searchTerm, filterStatus, filterMonth, filterYear, filterSousSociete]);
    ...
    return (
        <div className="space-y-6 pb-8 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col gap-4">
                <div className="bg-card p-4 rounded-2xl border border-border shadow-sm flex flex-wrap justify-between items-center gap-4 backdrop-blur-sm">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        >
                            ...
                            Filtres
                            {(filterStatus !== "all" || filterMonth !== "all" || filterYear !== "all" || filterSousSociete !== "all") && (
                ...
                {showFilters && (
                    <div className="bg-muted/30 p-4 rounded-[1.5rem] border border-border grid grid-cols-1 sm:grid-cols-4 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
