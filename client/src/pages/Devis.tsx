...
function Devis() {
    ...
    const exportToPDF = async () => {
        try {
            ...
            autoTable(doc, {
                startY: 45,
                head: [["Numéro", "Client", "Type", "Montant TTC", "Date", "Statut", "Utilisateur"]],
                body: tableData,
                theme: "grid",
                headStyles: {
                    fillColor: [67, 56, 202],
    ...
    useEffect(() => {
        const state = location.state as { selectedProduct?: Product };
        if (state?.selectedProduct) {
            const nature = String(
                                        ...
                                        <Table className="h-full" containerClassName="overflow-visible">
                                            <TableHeader>
                                                <TableRow className="bg-muted/30">
                                                    ...
                                                    <TableHead className="text-[10px] font-bold uppercase text-center py-4">Prix Unitaire (HT)</TableHead>
                    ...
                    <div className="p-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <Card className="bg-muted/30 border-none shadow-none p-4 rounded-xl transition-all hover:bg-muted/50">
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1.5">Total HT</p>
