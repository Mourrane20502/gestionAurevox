...
function inferVariantFromTypeLabel(
    ...
    if (!n) return null;
    if (metal === "silver") {
        if (/\brafinity\b/.test(n)) return "rafinity";
...
function findTypeIdByMetalVariant(
    ...
    const variantKeywords =
        variant === "beldy" ? ["beldy", "beldi"] : [variant];
...
export default function Products() {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const [productsRes, categoriesRes, pdvRes, productTypesRes, gestionnaireRes, metalPricingRes] = await Promise.all([
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [searchTerm, showOnlyLowStock, filterReference, filterPdv, filterProductType, filterNature, filterGrammeMin, filterGrammeMax, filterPriceSort, filterDisponibilite]);
    ...
    .filter((p) => {
        ...
        return matchesSearch && matchesReference && matchesPdv && matchesProductType && matchesNature && matchesGrammeMin && matchesGrammeMax && matchesDisponibilite && matchesLowStock;
    })
    .sort((a, b) => {
                    ...
                    <div className="bg-card rounded-xl border border-border shadow-sm p-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <Select onValueChange={(v) => setFilterProductType(v === "__all__" ? "" : v)} value={filterProductType || "__all__"}>
                                    <SelectTrigger className="h-9 bg-background border-border text-sm">
                                        <div className="flex items-center gap-2">
