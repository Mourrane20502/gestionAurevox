...
export default function Products() {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [searchTerm, showOnlyLowStock, filterReference, filterPdv, filterCategory, filterProductType, filterMetalVariant, filterNature, filterGrammeMin, filterGrammeMax, filterPriceSort, filterDisponibilite]);
    ...
    .filter((p) => {
        ...
        return matchesSearch && matchesReference && matchesPdv && matchesCategory && matchesProductType && matchesMetalVariant && matchesNature && matchesGrammeMin && matchesGrammeMax && matchesDisponibilite && matchesLowStock;
    })
    .sort((a, b) => {
