...
export default function Dashboard() {
    ...
    const quickActions = [
        { title: "Nouveau Devis", href: "/dashboard/devis/nouveau", icon: FileText, bg: "bg-indigo-500/10", color: "text-indigo-600" },
        { title: "Nouvelle Commande", href: "/dashboard/commandes/nouveau", icon: Receipt, bg: "bg-emerald-500/10", color: "text-emerald-600" },
        { title: "Nouvelle Facture", href: "/dashboard/factures/nouveau", icon: FileText, bg: "bg-blue-500/10", color: "text-blue-600" },
                            ...
                            <Card className={cn(dashGlassCard, "p-1 rounded-[2.5rem] border-none shadow-xl overflow-hidden")}>
                                <CardContent className="p-8 sm:p-10 space-y-8">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <Link to="/dashboard/activities" className="h-10 w-10 rounded-2xl bg-violet-500/10 text-violet-600 flex items-center justify-center hover:scale-110 transition-transform">
